...
add wave -noupdate -color Cyan -format Literal /tb_cu/dut/mux_b_sel
...
add wave -noupdate -color Cyan -format Literal /tb_cu/dut/jump_type
...
add wave -noupdate -format Logic /tb_cu/dut/bubble
...
add wave -noupdate -color {Cornflower Blue} -format Literal /tb_cu/dut/ir_opcode
add wave -noupdate -color {Cornflower Blue} -format Literal /tb_cu/dut/ir_func
